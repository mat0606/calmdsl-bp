...
sed -i 's/DM3-POC022/PHX-POC155/g' windows-single-vm/blueprint.py
sed -i 's/PP Cluster/NTNX_LOCAL_AZ_ITC/g' windows-single-vm/blueprint.py
sed -i 's/ntnxlab.local/ntnxlab1.local/g' windows-single-vm/blueprint.py
sed -i 's/10.55.35.56/10.55.88.59/g' windows-single-vm/blueprint.py
...
sed -i 's/Calm_Secondary_OTC/Calm_Primary_ITC/g' win-multi-vm/blueprint.py
sed -i 's/DM3-POC088/PHX-POC155/g' win-multi-vm/blueprint.py
sed -i 's/NTNX_LOCAL_AZ_OTC/NTNX_LOCAL_AZ_ITC/g' win-multi-vm/blueprint.py
...
calm launch bp "Windows2022AD" --app_name Windows2022-3 -p "Small" --environment ITC_VLAN
