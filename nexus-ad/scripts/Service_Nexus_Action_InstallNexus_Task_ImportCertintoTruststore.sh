...
sudo keytool -delete -alias jetty -storepass changeit -keystore @@{jre_path}@@/lib/security/cacerts -noprompt
...
sudo keytool -importcert -file nexus_server.pem -alias jetty -storepass changeit -keystore @@{jre_path}@@/lib/security/cacerts -noprompt