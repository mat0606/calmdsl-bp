...
if "@@{nutanix_cluster}@@ == PHX-POC080":
  print "pe_sc_credential={}".format("@@{PE_SC_Creds.secret}@@")
elif "@@{nutanix_cluster}@@ == PHX-POC027":
  print "pe_sc_credential={}".format("@@{PE_SC_Creds2.secret}@@")
elif "@@{nutanix_cluster}@@ == PHX-POC169":
  print "pe_sc_credential={}".format("@@{PE_SC_Creds3.secret}@@")
elif "@@{nutanix_cluster}@@ == PHX-POC171":
  print "pe_sc_credential={}".format("@@{PE_SC_Creds4.secret}@@")
elif "@@{nutanix_cluster}@@  == PHX-POC296":
  print "pe_sc_credential={}".format("@@{PE_SC_Creds5.secret}@@")
else:
