...
class RHEL_Svc(Service):
    ...
    def __start__():
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts", "Service_RHEL_Svc_Action___start___Task_StartApache.sh"
            ),
    ...
    def __stop__():
        ...
        CalmTask.Exec.ssh(
            name="Stop Apache",
            filename=os.path.join(
                "scripts", "Service_RHEL_Svc_Action___stop___Task_StopApache.sh"
            ),
            cred=ref(BP_CRED_RHEL),
            target=ref(RHEL_Svc),
        )
    ...
    @action
    def InstallApache(name="Install Apache"):

        CalmTask.Exec.ssh(
            name="Install Apache",
            filename=os.path.join(
                "scripts", "Service_RHEL_Svc_Action_InstallApache_Task_InstallApache.sh"
            ),
            cred=ref(BP_CRED_RHEL),
            target=ref(RHEL_Svc),
        )
    ...
    def Configuredisk(name="Configure disk"):
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts",
                "Service_RHEL_Svc_Action_Configuredisk_Task_CurrentDiskInformation.sh",
            ),
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts",
                "Service_RHEL_Svc_Action_Configuredisk_Task_Configuretouse2nddisk.sh",
            ),
            cred=ref(BP_CRED_ROOT),
            target=ref(RHEL_Svc),
        )
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts", "Service_RHEL_Svc_Action_Configuredisk_Task_Mountthedrive.sh"
            ),
            cred=ref(BP_CRED_ROOT),
            target=ref(RHEL_Svc),
        )
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts",
                "Service_RHEL_Svc_Action_Configuredisk_Task_Configurefstab.sh",
            ),
            cred=ref(BP_CRED_ROOT),
            target=ref(RHEL_Svc),
        )
        ...
        CalmTask.Exec.ssh(
            ...
            filename=os.path.join(
                "scripts",
                "Service_RHEL_Svc_Action_Configuredisk_Task_Verifyfstabmount.sh",
            ),
            cred=ref(BP_CRED_ROOT),
            target=ref(RHEL_Svc),
        )

        RHEL_Svc.__restart__(name="Restart the VM")

        CalmTask.Exec.ssh(
            name="Verify Mount information",
            filename=os.path.join(
                "scripts",
                "Service_RHEL_Svc_Action_Configuredisk_Task_VerifyMountinformation.sh",
            ),
            cred=ref(BP_CRED_ROOT),
            target=ref(RHEL_Svc),
        )
...
class rcalm_timeResources(AhvVmResources):
    ...
    disks = [
        ...
        AhvVmDisk.Disk.Scsi.allocateOnStorageContainer(1000),
    ]
...
class UpdateVMSpec_Update_ConfigAttrs778f938e(AhvUpdateConfigAttrs):
...
class Package1(Package):
    ...
    def __install__():
        ...
        RHEL_Svc.Configuredisk(name="Configure Disk")

        RHEL_Svc.JoinADDomain(name="Join AD Domain")

        RHEL_Svc.InstallApache(name="Install Apache")
...
class Package3(Package):
    ...
    def __install__():
        ...
        RHEL_Svc.InstallApache(name="Install Apache Web Server")
...
class Package4(Package):
    ...
    def __install__():
        ...
        RHEL_Svc.JoinADDomain(name="Action1")
...
class Small(Profile):
    ...
    patch_list = [
        AppEdit.UpdateConfig(
            ...
            patch_attrs=UpdateVMSpec_Update_ConfigAttrs778f938e,
        )
    ]
...
class ApacheWebServer(Blueprint):
